...
// an input type, and retrieve either the items registered
...
_.extend(Backbone.Syphon.TypeRegistry.prototype, {
  ...
  // Get the registered items by type. If nothing is
  ...
  // Register a new items for a specified type
  register: function(type, item){
    this.registeredTypes[type] = item;
  },

  // Register a default items to be used when no
  // items for a specified type is found
  registerDefault: function(item){
    this.registeredTypes["default"] = item;
  },

  // Remove an items from a given type registration
